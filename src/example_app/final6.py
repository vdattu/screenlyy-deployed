        ...
        try:
            ...
            if len(thread_list)>4:
                ...
                while True:
                    ...
                    #     print("break in inner while1234567890")
                    #     break
                    #time.sleep(0.5)
                    print(r1)
                    r_id = get_rule_id(r1)
                    ...
                    print(name,mimetype)
                    threading.Thread(target = insert_details,args = [device_data[2],device_data[0],name,mimetype,count,z,r1])
